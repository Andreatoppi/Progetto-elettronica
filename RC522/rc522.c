...
/*
 * Funzione: Write_MFRC5200
 * Descrizione: registro MFRC522
 * Parametri di input: addr - indirizzo del registro, valore val da scrivere
 * Valore restituito:
 */ 
...
/*
 * Funzione: Read_MFRC522
 * Descrizione: Leggi il registro MFRC522
 * Parametri di input: addr - indirizzo del registro
 * Valore restituito: restituisce un byte di dati
 */ 
...
/*
 * Funzione: SetBitMask
 * Descrizione: imposta il bit di registro RC522
 * Parametri di input: reg - registri indirizzo, maschera - imposta valore
 * Valore restituito:
 */ 
...
/*
 * Funzione: ClearBitMask
 * Descrizione: Cancella il bit di registro RC522
 * Parametri di input: reg - registra indirizzo, maschera - cancella il valore del bit
 * Valore restituito:
 */
...
/*
 * Funzione: MFRC522_Request
 * Descrizione: trova la carta e leggi il suo tipo
 * Valori di input: reqMode - modo per trovare la carta;
 * TagType - restituisce il tipo di carta:
 * 0x4400 = Mifare_UltraLight
 * 0x0400 = Mifare_One (S50)
 * 0x0200 = Mifare_One (S70)
 * 0x0800 = Mifare_Pro (X)
 * 0x4403 = Mifare_DESFire
 * Valore di output: esito positivo MI_OK
 */ 
...
/*
 * Funzione: MFRC522_ToCard
 * Descrizione: comunicazione scheda RC522 e ISO14443
 * Valori di input: comando - comando MF522
 * sendData - Dati RC522,
 * sendLen - invia la lunghezza dei dati
 * backData - I dati ricevuti sono resi,
 * backLen - Restituisce la lunghezza dei bit di dati
 * Valore di output: ritorno corretto MI_OK
 */ 
...
/*
 * Funzione: MFRC522_Anticoll
 * Descrizione: lettura del numero di serie
 * Valori di input: numero di serie - il numero del checksum
 * Valore di output: ritorno corretto MI_OK
 */ 
...
/*
 * Funzione: CalulateCRC
 * Descrizione: Calcola il CRC MF522
 * Valori di input :: pIndata - leggi dati CRC, len - lunghezza dei dati, pOutData - risultati CRC calcolati
 * Valore di output:
 */ 
...
/*
 * Funzione: MFRC522_SelectTag
 * Descrizione: tessera elettorale, leggere la capacità della memoria
 * Valori di input: serNum - numero di serie della carta in entrata
 * Valore di output: ripristino della capacità della carta
 */ 
...
/*
 * Funzione: MFRC522_Auth
 * Descrizione: verificare la password della carta
 * Valori di input: authMode - Modalità di autenticazione Passowrd
                 0x60 = verifica una chiave
                 0x61 = Verifica la chiave B.
             BlockAddr - Block address
             Sectorkey - La password del settore
             serNum - Numero di serie della scheda, 4 byte
 * Valore di output: ritorno corretto MI_OK
 */ 
...
/*
 * Funzione: MFRC522_Lead
 * Descrizione: legge i dati del blocco
 * Valori di input: blockAddr - indirizzo del blocco; recvData - legge un blocco di dati
 * Valore di output: ritorno corretto MI_OK
 */ 
...
/*
 * Funzione: MFRC522_Write
 * Descrizione: scrivere i dati del blocco
 * Valori di input: blockAddr - indirizzo del blocco; 16 writeData - 16
 * Valore di output: ritorno corretto MI_OK
 */
...
/*
 * Funzione: ResetMFRC522
 * Descrizione: ripristina RC522
 * Valori di input:
 * Valore di output:
 */ 
...
/*
 * Funzione: AntennaOn
 * Descrizione: Accensione pronta all'uso, intervallo minimo di 1 ms tra ciclo on / off
 * Valori di input:
 * Valore restituito:
 */ 
...
/*
 * Funzione: AntennaOff
 * Descrizione: spegnimento dopo l'uso, intervallo minimo di 1 ms tra ciclo on / off
 * Valori di input:
 * Valore di output:
 */
...
/*
 * Funzione: MFRC522_Halt
 * Descrizione: Invia scheda per dormire
 * Valori di input:
 * Valore di output:
 */ 
